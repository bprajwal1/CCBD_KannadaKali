...
public class QuizA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageA = this.findViewById(R.id.quizAImageA);
        context = imageA.getContext();
        id = context.getResources().getIdentifier("text_" + choices.get(0), "mipmap", context.getPackageName());
        imageA.setImageResource(id);

        ImageView imageB = this.findViewById(R.id.quizAImageB);
        context = imageB.getContext();
        id = context.getResources().getIdentifier("text_" + choices.get(1), "mipmap", context.getPackageName());
        imageB.setImageResource(id);

        ImageView imageC = this.findViewById(R.id.quizAImageC);
        context = imageC.getContext();
        id = context.getResources().getIdentifier("text_" + choices.get(2), "mipmap", context.getPackageName());
        imageC.setImageResource(id);

        ImageView imageD = this.findViewById(R.id.quizAImageD);
        context = imageD.getContext();
        id = context.getResources().getIdentifier("text_" + choices.get(3), "mipmap", context.getPackageName());
        ...
        ImageView home = (ImageView) findViewById(R.id.quizAHome);
